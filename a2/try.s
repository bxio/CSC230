...
@ === Printing the diagonal of a matrix given pointer and dimensions
	@ void RdMat(Mat:r1;Row:r2;Col:r3)
	@ Input parameters:
	@	r1 = address of MatMain
	@	r2 = Row size of MatMain
	@	r3 = Column size of MatMain
	@ Output parameters: None
	@ Side Effects: Prints the diagonal of the given function
diagFunction:
	STMFD	sp!,{r0-r3,lr}
...
@ ==== Compute the transpose and store it in MatTransp
	@ void TrFunc(Row:r1;Col:r2;Mat:r3;Mat:r4;Transp:r5)
	@ Input parameters:
	@	r1 = RsizeM = CsizeTR
	@	r2 = CsizeM = RsizeTR
	@	r3 = Address of MatMain, row anchor - acts as counter for rows
	...
	@	r5 = Address of MatTransp
	@ Output parameters: None
	@ Side effects: MatTransp is filled with elements
TrFunc:
	STMFD sp!,{r1-r5,lr}
	@Grab and swap the row size and col size.
...
@ ===  (4) If matrix is square,check if symmetric and print message
	@ void SymmFunc(Mat:r0;Transp:r1)
	@ Input parameters:
	@	r0: pointer to MatMain
	@	r1: pointer to MatTransp
	@ Output parameters: None
	@ Side Effects: Prints whether matrix is Symmetric or Not Symmetric
...
@ === (5) If matrix is square,check if skew -symmetric and print message
	@ void SkSymmFunc(Mat:r0;Transp:r1)
	@ Input parameters:
	@	r0: pointer to MatMain
	@	r1: pointer to MatTransp
	@ Output parameters: None
	@ Side Effects: Prints whether matrix is Skew-Symmetric or Not Skew-Symmetric
